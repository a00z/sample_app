...
describe "User pages" do
    ...
    describe 'follow/unfollow buttons' do
      ...
      describe 'following a user' do
        ...
        it 'should increment the followed user count' do
          expect do
            click_button 'Follow'
          end.to_change(user.followed_users, :count).by(1)
        end

        it 'should increment the other user\'s followers count' do
          expect do
            click_button 'Follow'
          end.to_change(other_user.followers, :count).by(1)
        end
  ...
  describe "signup" do
    ...
    describe 'with invalid information' do
      ...
      describe 'in e-mail address' do
        before do
          fill_in 'Email', with: 'fred@hotmail.'
          click_button submit
        end
  ...
  describe "edit" do
    ...
    describe "page" do
      it {should have_page_title('Update your profile', 'Edit user')}
